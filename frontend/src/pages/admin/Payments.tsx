      ...
      case 'TIMEOUTED':
        return (
          <Badge variant="danger" className="flex items-center gap-1">
            <X size={12} />
            {t('admin.paymentStatus.cancelled')}
          </Badge>
        )
      case 'REFUNDED':
        return (
          <Badge variant="info" className="flex items-center gap-1">
            {t('admin.paymentStatus.refunded')}
          </Badge>
        )
      default:
      ...
      {isLoading ? (
                        ...
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            <p className="font-medium text-neutral-900 dark:text-white">
                              {payment.userName || t('admin.payments.unknown')}
                            </p>
                            <div className="flex items-center gap-2 text-sm text-neutral-500 dark:text-neutral-400">
                              ...
                              <span>·</span>
                              <span>{payment.creditPackageName || t('admin.payments.package')}</span>
                            </div>
                          </div>
                        </div>
        ...
        <Card variant="bordered">
          <div className="text-center py-12">
            ...
            <p className="text-neutral-500 dark:text-neutral-400">{t('admin.payments.noPayments')}</p>
          </div>
        </Card>
      )}
    </div>
