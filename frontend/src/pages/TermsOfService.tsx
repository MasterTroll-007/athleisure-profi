        ...
        <Card variant="bordered" padding="lg">
          ...
          <div className="space-y-6 text-neutral-700 dark:text-neutral-300 text-sm leading-relaxed">
            <section>
              ...
              <p>Tyto obchodní podmínky upravují vztah mezi provozovatelem rezervačního systému na doméně rezervace-pankova.online a uživatelem při využívání služby online rezervace osobních tréninků.</p>
            </section>
