...
class CreditService(
    ...
    fun sumCreditsSoldInPeriod(from: java.time.Instant, to: java.time.Instant, trainerId: UUID): Long {
        return creditTransactionRepository.sumAmountByTypeAndDateRangeForTrainer(
            "purchase",
            from,
            to,
            trainerId
